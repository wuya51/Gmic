...
const getWebAuthnAttestationTurnkeyAdapter = (options) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const attestation = yield createWebauthnCredential.createWebauthnCredential(convertPublicKeyToWebauthn(options.publicKey));
...
const convertAttestationResultToTurnkey = (attestation) => {
    ...
    return ({
        ...
        transports: ((_a = attestation.response.transports) === null || _a === void 0 ? void 0 : _a.map(convertTransportEnumToTurnkeyEnum.convertTransportEnumToTurnkeyEnum)) ||
            [],
    });
};
...
exports.convertAttestationResultToTurnkey = convertAttestationResultToTurnkey;
exports.convertPublicKeyToWebauthn = convertPublicKeyToWebauthn;
