 ...
 */ const createCore = (config)=>{
    ...
    const storage = createStorage({
        ...
        storageAdapter: (_config_coreConfig_storageAdapter = (_config_coreConfig2 = config.coreConfig) == null ? void 0 : _config_coreConfig2.storageAdapter) != null ? _config_coreConfig_storageAdapter : createLocalStorageAdapter()
    });
...
class UnrecognizedNetworkError extends BaseError {
...
class UserRejectedError extends BaseError {
    constructor({ action }){
        super({
            cause: null,
            code: 'user_rejected',
 ...
 */ const selectPrimaryWalletAccount = async ({ walletAccount }, client = getDefaultClient())=>{
    ...
    if (walletAccount.verifiedCredentialId) {
        ...
        const updatedWalletAccount = _extends({}, walletAccount, {
