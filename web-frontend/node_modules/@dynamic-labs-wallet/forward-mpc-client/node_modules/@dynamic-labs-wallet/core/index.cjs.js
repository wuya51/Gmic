...
class DynamicApiClient extends BaseClient {
    ...
    async publishDelegatedKeyShare({ walletId, encryptedKeyShare, signedSessionId, encryptionVersion, requiresSignedSessionId = false, dynamicRequestId }) {
        if (requiresSignedSessionId && !signedSessionId) {
            throw new Error('Signed session ID is required');
        }
        const apiClient = this.apiClient;
        const { data } = await apiClient.post(`/api/v0/sdk/${this.environmentId}/waas/${walletId}/delegatedAccess/delivery`, {
