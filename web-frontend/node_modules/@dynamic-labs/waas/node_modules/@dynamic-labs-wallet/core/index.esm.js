...
class DynamicApiClient extends BaseClient {
    ...
    async createWalletAccount({ chainName, clientKeygenIds, dynamicRequestId, thresholdSignatureScheme, skipLock, onError, onCeremonyComplete }) {
    ...
    async reshare({ walletId, dynamicRequestId, clientKeygenIds, oldThresholdSignatureScheme, newThresholdSignatureScheme, delegateToProjectEnvironment, revokeDelegation, mfaToken, onError }) {
        return createEventStreamPromise({
            apiClient: this.apiClient,
            dynamicRequestId,
    ...
    async getDelegatedEncryptionKey({ environmentId }) {
    ...
    async publishDelegatedKeyShare({ walletId, encryptedKeyShare, signedSessionId, requiresSignedSessionId = false, dynamicRequestId }) {
    ...
    async getWaasWalletById({ walletId }) {
    ...
    async delegatedSignMessage({ walletId, message, isFormatted, dynamicRequestId, onError, context }) {
        return createEventStreamPromise({
            apiClient: this.apiClient,
            dynamicRequestId,
