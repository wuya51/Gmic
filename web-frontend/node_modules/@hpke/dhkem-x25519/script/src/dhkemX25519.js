(function (factory) {
    ...
    class X25519 {
        ...
        async generateKeyPair() {
            try {
                const rawSk = await x25519_js_1.x25519.utils.randomSecretKey();
        ...
        _derivePublicKey(k) {
            return new Promise((resolve, reject) => {
                try {
                    const pk = x25519_js_1.x25519.getPublicKey(k.key);
        ...
        _dh(sk, pk) {
            return new Promise((resolve, reject) => {
                try {
                    resolve(x25519_js_1.x25519.getSharedSecret(sk.key, pk.key).buffer);
                }
                catch (e) {
                    reject(e);
                }
        ...
        _derive(sk, pk) {
            return new Promise((resolve, reject) => {
                try {
                    resolve(x25519_js_1.x25519.getSharedSecret(sk, pk));
                }
                catch (e) {
                    reject(e);
                }
