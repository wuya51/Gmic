...
var ICONS = {
  add: async () => (await import("./add-OE7ODGYY.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-OX6RMFZY.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-B2JR7SX3.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-2C323V36.js")).appStoreSvg,
  apple: async () => (await import("./apple-AJ3HG2MR.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-UPOLDHGD.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-DHCDUART.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-4F3VANG5.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-5UXDI6B7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-FEXMMAFR.js")).bankSvg,
  browser: async () => (await import("./browser-LYMRVZOS.js")).browserSvg,
  card: async () => (await import("./card-ADI35KEN.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-URTGT343.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-6KD6UX3O.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-YXYKG5FQ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-OR5NZLT5.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-NLDTZKBK.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-N5DU4IWO.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-OOYIXR4P.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ADFPZCCJ.js")).clockSvg,
  close: async () => (await import("./close-7GPH62MP.js")).closeSvg,
  compass: async () => (await import("./compass-NFCJRXM6.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-DRLXYY4I.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-5IIHIQQR.js")).copySvg,
  cursor: async () => (await import("./cursor-CX6N3T5L.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-FJT3LCSI.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-Z57ZQVZZ.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-YVN3MIYG.js")).disconnectSvg,
  discord: async () => (await import("./discord-R4HUHWUV.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-SNBW7WQU.js")).etherscanSvg,
  extension: async () => (await import("./extension-AEMMPQTM.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-QRGJVFHH.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-W2TI53ZG.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ITC5Z5J5.js")).farcasterSvg,
  filters: async () => (await import("./filters-G4BAZPH2.js")).filtersSvg,
  github: async () => (await import("./github-YDJVUOAS.js")).githubSvg,
  google: async () => (await import("./google-BOM2QCZH.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-2XSASL6P.js")).helpCircleSvg,
  image: async () => (await import("./image-65VZ62PZ.js")).imageSvg,
  id: async () => (await import("./id-CHFJUTY4.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-DGENKSP7.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-RHNCZIVN.js")).lightbulbSvg,
  mail: async () => (await import("./mail-5VBXXSA4.js")).mailSvg,
  mobile: async () => (await import("./mobile-J3QBVHIL.js")).mobileSvg,
  more: async () => (await import("./more-F4GHXK2U.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-RU5S47HD.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-4RWUXDXQ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-2WH6BPZS.js")).offSvg,
  playStore: async () => (await import("./play-store-EM6FSCYB.js")).playStoreSvg,
  plus: async () => (await import("./plus-MX5LXXT5.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-X5ECLSAA.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-77SOHBO3.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-ZNNFSE37.js")).refreshSvg,
  search: async () => (await import("./search-RXKUEUXI.js")).searchSvg,
  send: async () => (await import("./send-HKOKRN5F.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-G5W64FLY.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-Z2LBXWSK.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-MJC4SVKV.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-SZUJHBH3.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-NJMIDP67.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-IUSFHL6C.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-Z6FZJOLH.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-CFTIBXTK.js")).twitchSvg,
  twitter: async () => (await import("./x-BS7KWHQ4.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-NSOB5G6O.js")).twitterIconSvg,
  verify: async () => (await import("./verify-SJCAN7QX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-NTK3ZULX.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-DYYA2QXO.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-EYLEJF4L.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-EYLEJF4L.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-EYLEJF4L.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-7X7LOPTB.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-VAE5CIUQ.js")).warningCircleSvg,
  x: async () => (await import("./x-BS7KWHQ4.js")).xSvg,
  info: async () => (await import("./info-H57YF2GT.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-GEEOHNIX.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-ZZLKIQT3.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ODRCL756.js.map
