 ...
 */ const consumeMfaToken = (client = constants.getDefaultClient())=>{
    const core = constants.getCore(client);
    const mfaToken = core.state.get().mfaToken;
    constants.assertDefined(mfaToken, 'No MFA token found');
    core.state.set({
        mfaToken: null
    });
    return mfaToken;
 ...
 */ const getMfaMethods = async (client = constants.getDefaultClient())=>{
    const core = constants.getCore(client);
 ...
 */ const isMfaRequiredForAction = async ({ mfaAction }, client = constants.getDefaultClient())=>{
...
exports.isMfaRequiredForAction = isMfaRequiredForAction;
