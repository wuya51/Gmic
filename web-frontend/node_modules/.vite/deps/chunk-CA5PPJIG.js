  ...
  block: defineBlock({
    format(args) {
      ...
      const transactions = (_a = args.transactions) == null ? void 0 : _a.map((transaction) => {
        ...
        if (typeof transaction === "string")
          return transaction;
        const formatted = (_a2 = formatters2.transaction) == null ? void 0 : _a2.format(transaction);
...
//# sourceMappingURL=chunk-CA5PPJIG.js.map
